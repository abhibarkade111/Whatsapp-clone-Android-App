...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String status = binding.sStatus.getText().toString();
                String username =  binding.sUsername.getText().toString();
        ...
        database.getReference().child("Users").child(FirebaseAuth.getInstance().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Picasso.get().load(users.getProfilepic()).placeholder(R.drawable.defaultpic).into(binding.profileImageSetting);
                binding.sUsername.setText(users.getUsername());
                binding.sStatus.setText(users.getStatus());
            }
